...
# (0.7 ложных против 5.3), но пропускает **больше** срочных случаев, чем даже
# грубый порог по расходу. Оно покупает экономию пропусками, и без матрицы
# потерь это не видно ни в accuracy, ни в F1.
