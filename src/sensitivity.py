...
if __name__ == "__main__":
    ...
    if dead:
        ...
        print("Это не баг реализации, а следствие структуры из §3.2 диплома:")
        print("узел объявлен в Табл. 3.2 как вход, но причинных дуг от него текст")
        print("работы не описывает. Пока дуга не восстановлена, канал АИС по этому")
        print("параметру опрашивается впустую. См. README, «Известное ограничение».")
